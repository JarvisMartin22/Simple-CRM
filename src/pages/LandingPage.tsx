        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Folk CRM offers a range of powerful features designed to streamline your business operations.
            </p>
          </div>
      ...
      <footer className="bg-gray-900 text-gray-400 py-12 relative z-10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-white font-bold mb-4">Folk CRM</h3>
              <p className="text-sm">Simple CRM for growing businesses.</p>
            </div>
