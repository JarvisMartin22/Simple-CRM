-- Combined migration script for manual execution in Supabase web interface

-- From migration 20240530000001_add_full_name_to_contacts.sql
...
DROP TRIGGER IF EXISTS update_full_name_trigger ON public.contacts;
